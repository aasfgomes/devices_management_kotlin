...
@Composable
fun RegisterScreen(userViewModel: UserViewModel = viewModel(), onBackToLogin: () -> Unit) {
    ...
    Column(
        ...
        Button(
            onClick = {
                userViewModel.registerNewUser(username.value, password.value, email.value) // Chama a função de registo no userViewModel
            },
